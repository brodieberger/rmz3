...
// 0x0834822c
const struct SpawnTemplate gOceanEntity[31] =
    {
        [0] = {0},
        [1] =
            {
        ...
        [7] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_ICEBON, 0, 0),
                .attr = SA_KNIGHT,
            },
        [8] =
            {
        ...
        [10] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_UNK_004, 1, 0),
                .attr = SA_KNIGHT,
            },
        [11] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_UNK_004, 0, 0),
            },
        [12] =
            {
                .flag = SF_RESPAWN,
        ...
        [16] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_ITEM, ITEM_DISK, 5, 2),
            },
        [17] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_ITEM, ITEM_DISK, 9, 2),
            },
        [18] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_ITEM, ITEM_DISK, 49, 2),
            },
        [19] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_ITEM, ITEM_DISK, 75, 2),
            },
        [20] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_ITEM, ITEM_GENERAL, ITEM_LIFE_S, 0),
            },
        [21] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_CONTAINER, 1, 59),
            },
        [22] =
            {
                .flag = SF_FLAG_1,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_CONTAINER, 1, 113),
            },
        [23] =
            {
                .flag = SF_FLAG_1,
        ...
        [27] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_OCEAN_ROD_WALL, 0, 0),
            },
        [28] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_UNK_004, 3, 0),
            },
        [29] =
            {
                .flag = SF_RESPAWN,
                .kind = SpawnEntity(ENTITY_SOLID, SOLID_UNK_004, 5, 0),
            },
        [30] =
            {
                .flag = 0xF,
...
// clang-format off
const struct SpawnPoint gOceanEntityCoord[86] = {
