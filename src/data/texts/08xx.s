...
Text_MissileFactory_YouMadeIt: @ 0x0838075E
	...
	.string "{WINDOW 0x04}"
		.string "Have you determined\n"
		.string "the missile's\n"
		.string "target?▼"
	.string "{WINDOW 0x64}"
		.string "Ciel:\n"
		.string "The target is...\n"
		.string "Area Z... 3079.▼"
		.string "What?! That's a\n"
		.string "human residential\n"
		.string "district!!!▼"
		.string "Wait, that's not\n"
		.string "all... The Dark Elf\n"
		.string "is there, too!▼"
	.string "{WINDOW 0x04}"
		.string "So he's trying to\n"
		.string "jump right in and\n"
		.string "take the Dark Elf...▼"
		.string "Understood.$"
	.else
	.string "{WINDOW 0x64}"
		.string "シエル:\n"
...
Text_MissileFactory_CielTheyLaunchedItZero: @ 0x08380828
	...
	.if ENGLISH
	.string "{WINDOW 0x00}"
		.string "Ciel: They launched it!▼"
		.string "Zero! Don't get any▼"
		.string "closer!$"
	.else
	.string "{WINDOW 0x00}"
...
Text_MissileFactory_IHaveToActNow: @ 0x0838084C
	...
	.if ENGLISH
	.string "{WINDOW 0x05}"
		.string "I have to act now,\n"
		.string "while Omega is\n"
		.string "immobile...▼"
		.string "I'll sneak in and\n"
		.string "stop both him and\n"
		.string "the missile.$"
	.else
	.string "{WINDOW 0x05}"
		.string "今ならオメガは動けない……▼"
...
Text_MissileFactory_OmegaWillGo: @ 0x083808C3
	...
	.if ENGLISH
	.string "{WINDOW 0x66}"
		.string "Omega will go\n"
		.string "rescue Mama!▼"
		.string "Don't get in his\n"
		.string "way! Leave!$"
	.else
	.string "{WINDOW 0x66}"
		.string "オメガにーちゃんは\n"
...
Text_MissileFactory_HeheGrandpaWill: @ 0x0838091C
	...
	.if ENGLISH
	.string "{WINDOW 0x66}"
		.string "Hehe! Grandpa will\n"
		.string "be so proud of us!▼"
	.string "{WINDOW 0x69}"
		.string "Haha! Grandpa will\n"
		.string "be so proud of us!$"
	.else
	.string "{WINDOW 0x66}"
		.string "あはははっ！ おじーちゃん\n"
...
Text_MissileFactory_WeMayHaveLost: @ 0x08380976
	...
	.if ENGLISH
	.string "{WINDOW 0x66}"
		.string "We may have lost,\n"
		.string "but the missile will\n"
		.string "land soon!▼"
		.string "Our mission is a\n"
		.string "success!$"
	.else
	.string "{WINDOW 0x66}"
		.string "まけちゃったけど\n"
...
Text_MissileFactory_HeyCanYouBeatUp: @ 0x08380A1E
	...
	.if ENGLISH
	.string "{WINDOW 0x66}"
		.string "Hey, can you beat up\n"
		.string "that bad Reploid for\n"
		.string "us?$"
	.else
	.string "{WINDOW 0x66}"
...
Text_MissileFactory_YeahCanYouBeat: @ 0x08380A39
	...
	.if ENGLISH
	.string "{WINDOW 0x69}"
		.string "Yeah, can you beat\n"
		.string "up that fake Reploid\n"
		.string "for us?$"
	.else
	.string "{WINDOW 0x69}"
...
Text_MissileFactory_WeTheReploidsOf: @ 0x08380A55
	...
	.string "{WINDOW 0x2C}"
		.string "...▼"
		.string "We, the Reploids of\n"
		.string "Neo Arcadia...▼"
		.string "We are defenders of\n"
		.string "humanity. The only\n"
		.string "justice here.▼"
		.string "Is this wasteland\n"
		.string "what you people\n"
		.string "call justice?!▼"
		.string "Weil!!!$"
	.else
	.string "{WINDOW 0x2C}"
...
Text_MissileFactory_CielZeroDonTMove: @ 0x08380AF2
	...
	.if ENGLISH
	.string "{WINDOW 0x00}"
		.string "Ciel: Zero, don't move!▼"
		.string "I'll transfer you to the▼"
		.string "base, now!$"
	.else
	.string "{WINDOW 0x00}"
		.string "シエル「ゼロ、動かないで！▼"
