...
Script_08351fac:
  cutscene_start CS_MISSILE_MISSION
...
Script_08352124:
  cutscene_start CS_MISSILE_LAUNCH
  lock
  force 0, 0, 0
  force 8, 0, 0
  turn_right 0
  ...
  cmd1c 3, 0, 1600*PX
  force 13, 0, 0
  set_entity_coords 0, Coord_08351eb4
  turn_left 0
  ...
  wait 1
  change_camera_mode 1
  set_camera_target_x 5640*PX
  set_camera_target_y 1560*PX
  set_chase_mode 2
  wait_transition_end
  message 1, 0, 0x0802
  wait_msgbox_end
...
Script_08352a6c:
  unlockmenu
  cutscene_start CS_MISSILE_23
  normal_screen
  wait_transition_end
  wait 28
  time 0
  play_se 231
  message 1, 0, 0x080F @ グ…オオ…！
  wait_msgbox_end
  waitabs 120
  play_bgm 223
  blackout_screen
  ...
  wait 15
  message 1, 0, 0x0810 @ わーい！ おかーさん！ おかーさん！
  wait_msgbox_end
  wait 15
  play_se 277
  entityflag 4, 7, TRUE
